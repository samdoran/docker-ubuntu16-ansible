...
[![Container Repository on Quay](https://quay.io/repository/samdoran/ubuntu16-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/ubuntu16-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t ubuntu16-ansible -f Containerfile .
